...
func (c *AssetManagement) Init(stub shim.ChaincodeStubInterface) pb.Response {
...
// ============================================================================================================================
func (c *AssetManagement) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
...
// ============================================================================================================================
// Administration order an equipment from OEM
// ============================================================================================================================
func (c *AssetManagement) Order(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	return c.UpdateAsset(stub, args, "ORDER", "ADMINISTRATION", "OEM")
}

// ============================================================================================================================
// OEM ship the equipment to Administration office
// ============================================================================================================================
func (c *AssetManagement) Ship(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	return c.UpdateAsset(stub, args, "SHIP", "OEM", "ADMINISTRATION")
}

// ============================================================================================================================
//  Administration Office Issue equipment to STORE
// ============================================================================================================================
func (c *AssetManagement) Issue(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	return c.UpdateAsset(stub, args, "ISSUE", "ADMINISTRATION", "STORE1")
}

// ============================================================================================================================
//  Initiate Asset
// ============================================================================================================================
func (c *AssetManagement) initAsset(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
// ============================================================================================================================
func (c *AssetManagement) UpdateAsset(stub shim.ChaincodeStubInterface, args []string, currentStatus string, from string, to string) pb.Response {
	assetId := args[0]
	comment := args[1]
	location := args[2]
...
//
// ============================================================================================================================
func (c *AssetManagement) query(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var ENIITY string
	var err error

	if len(args) != 1 {
		return shim.Error("Incorrect number of arguments. Expected ENTITY Name")
	}
...
//
// ============================================================================================================================
func (c *AssetManagement) getHistory(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func main() {
	...
	if err != nil {
		fmt.Printf("Error creating new AssetManagement Contract: %s", err)
	}
}